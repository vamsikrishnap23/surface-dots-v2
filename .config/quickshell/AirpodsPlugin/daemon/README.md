...
# OpenPods Linux (formerly LibrePods)
...
`librepods-ctl` is a small command-line tool that lets you access OpenPods (formerly LibrePods) from the terminal or via scripts, as long as the main application is running.
